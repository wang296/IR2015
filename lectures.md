...
- ### **Day 3**: Inverted Index and Query processing  ([slides]({{site.baseurl}}/docs/Inverted Index.pptx), [PDF]({{site.baseurl}}/docs/PDFs/Inverted Index.pdf))                      
...
- ### **Day 4**: Search result interface ([slides]({{site.baseurl}}/docs/Search Result Interface.pptx), [PDF]({{site.baseurl}}/docs/PDFs/Search Result Interface.pdf))        
...
- ### **Day 1**: Boolean and vector space model ([slides]({{site.baseurl}}/docs/Boolean&VS model.pptx), [PDF]({{site.baseurl}}/docs/PDFs/Boolean&VS model.pdf))                         
...
- ### **Day 2**: Modeling implicit feedback & Click modeling            
